 ...
 *   https://datatables.net/download/#dt/dt-1.10.25/b-1.7.1/b-html5-1.7.1/sp-1.3.0/sl-1.3.3
 *
 * Included libraries:
 *   DataTables 1.10.25, Buttons 1.7.1, HTML5 export 1.7.1, SearchPanes 1.3.0, Select 1.3.3
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"dt/dt-1.10.25/b-1.7.1/b-html5-1.7.1/sp-1.3.0/sl-1.3.3",
